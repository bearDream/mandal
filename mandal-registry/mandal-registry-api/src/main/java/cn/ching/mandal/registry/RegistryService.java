...
public interface RegistryService {
     ...
     * @param url Registration information , is not allowed to be empty, e.g: dubbo://10.20.153.10/cn.ching.menu.MenuService?version=1.0.0&application=jue
     */
     ...
     * @return The registered information list, which may be empty, the meaning is the same as the parameters of {@link NotifyListener)}.
     * @see NotifyListener
     */
