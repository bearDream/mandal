...
public class MulticastRegistry extends FailbackRegistry {
    ...
    private final ScheduledExecutorService cleanExecutor = Executors.newScheduledThreadPool(1, new NamedThreadFactory("MandalMulticastRegistryCleanTimer", true));
    ...
    public MulticastRegistry(URL url) {
        ...
        try {
            ...
            }, "MandalMulticastRegistryReceiver");
