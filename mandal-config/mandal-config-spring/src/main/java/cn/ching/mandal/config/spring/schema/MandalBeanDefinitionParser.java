 ...
 */
public class MandalBeanDefinitionParser implements BeanDefinitionParser {

    private static final Logger logger = LoggerFactory.getLogger(MandalBeanDefinitionParser.class);
    private static final Pattern GROUP_VERSION = Pattern.compile("^[\\-.0-9_a-zA-Z]+(\\:[\\-.0-9-a-zA-Z]+)?$");
    private final Class<?> beanClass;
    private final boolean required;

    public MandalBeanDefinitionParser(Class<?> beanClass, boolean required){
