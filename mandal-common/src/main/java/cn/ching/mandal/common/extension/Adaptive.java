...
public @interface Adaptive {
     ...
     * <p>
     * If the specified parameters are not found from {@link cn.ching.mandal.common.URL}, then the mandal extension will be used for
     ...
     * <li>use mandal extension if 'key2' doesn't appear either</li>
     * <li>otherwise, throw {@link IllegalStateException}</li>
     * </ol>
     * If mandal extension's name is not give on interface's {@link SPI}, then a name is generated from interface's
     * class name with the rule: divide classname from capital char into several parts, and separate the parts with
     * dot '.', for example: for {@code com.alibaba.dubbo.xxx.YyyInvokerWrapper}, its mandal name is
