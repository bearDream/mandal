...
public class Constants {
    ...
    public static final String SERVICE_FILTER_KEY = "services.filter";
     ...
     * callback inst id
     */
    public static final String CALLBACK_SERVICE_KEY = "callback.services.instid";

    /**
     * The limit of callback services instances for one interface on every client
     */
    ...
    public static final String CALLBACK_SERVICE_PROXY_KEY = "callback.services.proxy";
